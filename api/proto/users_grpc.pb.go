...
type UsersClient interface {
	...
	GetAllUsers(ctx context.Context, in *GetAllUsersRequests, opts ...grpc.CallOption) (*GetAllUsersResponse, error)
}
...
func (c *usersClient) GetAllUsers(ctx context.Context, in *GetAllUsersRequests, opts ...grpc.CallOption) (*GetAllUsersResponse, error) {
	out := new(GetAllUsersResponse)
	err := c.cc.Invoke(ctx, "/protos.Users/GetAllUsers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UsersServer interface {
	...
	GetAllUsers(context.Context, *GetAllUsersRequests) (*GetAllUsersResponse, error)
...
func (UnimplementedUsersServer) GetAllUsers(context.Context, *GetAllUsersRequests) (*GetAllUsersResponse, error) {
...
func _Users_GetAllUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.Users/GetAllUsers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsersServer).GetAllUsers(ctx, req.(*GetAllUsersRequests))
	}
	return interceptor(ctx, in, info, handler)
}
